/* 
   TO SHOW CORRECTNESS DURING EVALUATION, MAKE N ON LINE-10 
   SMALL AND ADJUST UNCOMMENT THE ARRAY PRINT ON LINE 184
 */
...
int main(int argc, char **argv)
{
    ...
    if (id == 0)
    {
        printf("\nRunning merge sort on %d core(s)!\n", p);
//        printf("\n");
//        for (int i=0;i<n;i++) printf("%d ", data[i]);
//        printf("\n");
//        for (int i=0;i<n;i++) printf("%d ", chunk[i]);
//        printf("\n");
